...
- [ ] **Step 1: 重写 test_retry_utils.py 的 mock 策略**
...
- [ ] **Step 1: 在 conftest.py 顶层添加 WeasyPrint 可用性检测**
...
- [ ] **Step 2: 修改 test_pdf_converter.py——可用时运行，不可用时 skip**
...
- [ ] **Step 3: 处理 test_weasyprint_system_dep_missing 测试**
...
- [ ] **Step 4: 处理 test_chinese_content_rendering**
...
- [ ] **Step 5: 处理 test_markdown_not_installed_error**
...
- [ ] **Step 3: 如果构建通过，更新 Evidence Pack**
...
- [ ] **Step 4: 如果 E2E blocked，记录 partial evidence**
...
- [ ] **Step 1: 更新 README.md 和 README_CN.md 的 Evidence 表格**
