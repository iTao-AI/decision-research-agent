...
EXPECTED_OBSERVATIONS: dict[str, dict[str, bool | int | str]] = {
    ...
    "compose_loopback_required_secrets": {
        ...
        "credential_authority_separated": True,
    ...
    "container_health_privilege_contract": {
        ...
        "bootstrap_cap_drop_all_declared": True,
        "bootstrap_no_new_privileges_declared": True,
        "bootstrap_read_only_bind_declared": True,
